...
mod libc {
    pub use core::ffi::{c_char, c_int, c_long, c_schar, c_short, c_uchar, c_uint, c_ulong, c_ushort, c_void};
...
pub use cratecrate::crate::libc::c_int;
...
mod aws_lc {
    ...
    use cratecrate::crate::libc::{c_char, c_long, c_void};
            ...
            if #[cfg(unix)] {
                fn set_id_callback() {
                    unsafe extern "C" fn thread_id() -> c_ulong {
                        crate::cratecrate::crate::libc::pthread_self() as c_ulong
                    }
